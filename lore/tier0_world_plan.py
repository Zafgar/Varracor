...
TIER0_AREAS = OrderedDict({
    ...
    "greywash_ford": _area(
        ...
        dependencies=("whisper_marsh",),
        npcs=("Shanty Yard Saints patrol", "Ferrykeeper Oswin Pike", "Crown deserters"),
        quest_chains=(
            "Survey safe ford lanes",
            "Secure the crossing",
            "Repair the broken bridge",
            "Escort a caravan",
            "Search the abandoned watchtower",
        ),
        resources=("River Reed", "Clay", "Driftwood", "Scrap Iron", "ford fish"),
        creatures=("river predators", "Marshback Brute", "ford ambushers", "Crown deserters"),
        boss="Gutter Overflow or deserter captain",
        graphics=("procedural wide river", "ford stones", "broken bridge", "watchtower", "caravan road"),
        vfx=("fast current", "ford splashes", "foam", "rain flood state", "bridge debris"),
        systems=("crossing choices", "caravan escort", "fishing", "bridge development", "open-risk travel"),
        deliverables={
            "area": "next",
            "npcs": "next",
            "quests": "next",

...
TIER0_AREAS = OrderedDict({
    ...
    "whisper_marsh": _area(
        ...
        quest_chains=(
            ...
            "Map all three Whisper Pool banks",
        ...
        resources=(
            ...
            "Clay",
            "Nightcap Fungus",
            "Greywash and Whisper Pool fish",
        ),
        creatures=(
            "Mud Mite",
            "Reed Skitter",
        ...
        graphics=(
            "procedural water",
            "marsh props",
            "code-rendered monsters",
            "generated fishing scene",
            "generated Whisper Pool Maw",
        ),
        vfx=("currents", "shore foam", "rain ripples", "spores", "poison", "boss ripples"),
        systems=(
            "survey-post development",
            "named persistent quest chain",
            "monster ecology",
            "cast-hook-reel fishing",
            "line tension",
            "two-phase boss encounter",
        ),
        deliverables={
            "area": "live",
            "npcs": "live",
    ...
    "drowned_chapel": _area(
        ...
        systems=("rescue objectives", "water hazards", "quarantine reputation"),
        deliverables={
            "area": "next",
            "npcs": "next",
            "quests": "next",
    ...
    "old_muckford_mine": _area(
        ...
        4,
        (3, 7),
        "Mining dungeon, undead investigation and industrial recovery.",
    ...
    "tier0_finale": _area(
        ...
        quest_chains=("Win the Rookie Dust Circuit", "Resolve a major crisis", "Receive Bram's recommendation"),

...
TIER0_AREAS = OrderedDict({
    ...
    "kingsreach_toll": _area(
        ...
        ("stone causeway", "gatehouse", "toll booths", "quarantine tents", "caravan rest", "smuggler culvert"),
        "formal_gate",
        ("greywash_ford", "rattlebridge"),
        ...
        quest_chains=(
            ...
            "Present Garran Vale evidence for official papers",
            "Pay the full Crown toll",
            "Complete quarantine service",
            "Use the smuggler culvert and expose Crowl",
            "Receive stamped travel papers",
            "Carry the Crown Promotion Docket to Bram",
        ),
        resources=("Parchment Sheet", "Wax Seal", "Feverfew", "Clean Bandage", "Charcoal"),
        creatures=("Causeway Bandit", "Crown Toll Enforcer", "Fevered Escapee"),
        boss="Tollmaster Hadrik Crowl",
        graphics=(
            "3800x2300 generated Crown checkpoint",
            "stone causeway and gatehouse",
            "inspection booths and banners",
            "quarantine tent camp",
            "caravan yard and smuggler culvert",
            "generated checkpoint threats and Tollmaster",
        ),
        vfx=("banner movement", "road dust", "inspection braziers", "seal stamping", "quarantine haze", "Crown stamp shockwaves"),
        systems=(
            "Greywash and Rattlebridge route handoff",
            "official evidence route",
            "140 SP toll route",
            "quarantine service route",
            "35 SP smuggler route",
            "Crown reputation consequences",
            "daily checkpoint materials",
            "three-phase corrupt Tollmaster",
            "existing league promotion synchronization",
        ),
        deliverables=dict(MOSTLY_LIVE),
    ),
    "tier0_finale": _area(
        ...
        8,
        (5, 8),
        "Tie arena success, Muckford service and Crown-road clearance into an earned promotion.",
        ("Shanty Yard ceremony", "Bram's ledger office", "Muckford streets", "western departure"),
        "milestone",
        ("muckford", "kingsreach_toll"),
        dependencies=("muckford_warrens", "greywash_ford", "kingsreach_toll"),
        npcs=("Bram Mudhand Carrow", "Sera Quench's representative", "Marda Shant", "Hamo", "Muckford residents"),
        quest_chains=(

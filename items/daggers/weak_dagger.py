...
class WeakDagger(Weapon):
    def __init__(self):
        super().__init__()
        self.name = "Iron Dagger"
        self.rarity = "Common"
        self.cost = 40
        self.description = "A sharp and balanced dagger."
        ...
        self.charge_time = 0
        self.max_charge = 35 # Erittäin nopea lataus
    ...
    def _load_image(self):
        path = "assets/gear/daggers/weak_dagger.png"
    ...
    def draw_card_icon(self, surface, x, y, size):
        ...
        if img:
            ...
            pygame.draw.line(surface, (180, 180, 190), (x + size*0.4, y + size*0.6), (x + size*0.6, y + size*0.4), 3)
    ...
    def release_charge(self, owner, manager, target_pos):
        if self.charge_time > 10 and owner.attack_cooldown <= 0:
            ...
            throw_dmg = int(dmg * (0.9 + power * 0.6))
            speed = 20
    ...
    def draw_equipped(self, surface, unit_rect, facing_right, attack_cooldown, total_cooldown=60, attack_vector=None):
        ...
        angle = -90 if facing_right else 90
        scale = 1.0

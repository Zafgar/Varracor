...
class WeakBow(Weapon):
    def __init__(self):
        super().__init__()
        self.name = "Short Bow"
        self.rarity = "Common"
        self.cost = 40
        self.description = "Shoots arrows from a distance."
        
        # TÄRKEÄÄ: Tämä kertoo Gladiatorille ja AI:lle, että ase on ranged.
        self.type = "ranged" 
    ...
    def _load_image(self):
        path = "assets/gear/bows/weak_bow.png"
    ...
    def draw_card_icon(self, surface, x, y, size):
        ...
        if img:
            ...
            color = (139, 69, 19)
            rect = pygame.Rect(x+size*0.2, y+size*0.1, size*0.6, size*0.8)
            pygame.draw.arc(surface, color, rect, 3.14/2, 3.14*1.5, 3)
            pygame.draw.line(surface, (200, 200, 200), (x+size*0.5, y+size*0.1), (x+size*0.5, y+size*0.9), 1)

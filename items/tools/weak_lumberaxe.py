...
class WeakLumberAxe(Weapon):
    def __init__(self):
        super().__init__()
        self.name = "Weak Lumber Axe"
        self.rarity = "Common"
        self.cost = 50
        self.description = "A dull axe for chopping Tier 1 trees."
        
        self.type = "melee"
        self.slot_type = "main_hand"
        
        # TÄRKEÄ: Tämä yhdistää aseen Commanderin "Lumberjack" -taitoon
    ...
    def draw_card_icon(self, surface, x, y, size):
        if self.image:
            ...
            pygame.draw.circle(surface, (100, 100, 100), (x+size*0.8, y+size*0.2), size*0.2)

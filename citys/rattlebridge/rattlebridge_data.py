...
NAMED_NPCS = OrderedDict({
    ...
    "yorik_sparkspanner": {
        "name": "Yorik Sparkspanner",
        "race": "Gnome",
        "role": "Cog Wardens Manager • Gear-Master",
        "district": "scrapring_district",
        "position_norm": (0.72, 0.38),
        "color": (150, 130, 70),
        "dialogue": (
            "I keep the Scrapring's gears turning, so believe me when I say: the timing is a waltz, not a brawl.",
            "My Cog Wardens fight with the same snares we use to catch loose flywheels. Mind the sparks.",
            "Magnet plates pull on iron, not on courage. Cloth and leather walk right off them - remember that.",
            "Sera schedules the steam bursts for drama. I schedule them so the boiler does not level the district.",
            "Pib, Wren, Fizz, Kesk - and Durgan to hold the line while they wind their crossbows. Tidy little machine.",
            "A gnome built half this bridge's lift gear. The Union takes the credit; we take the maintenance fees.",
            "If a gear ever stops mid-match, do not cheer. Start running.",
        ),
    },
    "corwin_hale": {
        "name": "Corwin Hale",
        "race": "Human",
        "role": "Rattlebridge Runners Manager",
        "district": "span_ward",
        "position_norm": (0.47, 0.34),
        "color": (90, 110, 165),
        "dialogue": (
            "The Runners drill at dawn, march to the ring in step and bow to the crowd. Discipline is our brand.",
            "Jax anchors the wall, Sila and Brenna hold the flanks, Olek pins them from range, Miri lights the finish.",
            "Sera calls us her poster team. I call us employed. Both things pay the same bunkhouse.",
            "A Tier 1 fighter who dives at every feint is a Tier 0 fighter with a better contract.",
            "We do not brawl in The Span. Hendrik's cider is the only thing in this city that is not political.",
            "Watch the new teams from Muckford. Hungry mud beats polished steel more often than the odds say.",
            "Miri is Prism-trained, novice ring. One clean Spark Bolt at the right moment sells more posters than ten kills.",
        ),
    },
    "brasslight_tout": {
        "name": "Brasslight",
        ...
        "role": "Lantern Tout",
        "district": "canal_lift",
        "position_norm": (0.79, 0.72),
        "color": (110, 70, 110),
        "dialogue": (
            "Psst. Team looks thirsty for coin. I know a lantern that pours it.",
            "No names. You sign nothing, you shake nothing. The Ledger just... remembers you fondly.",
            "Big purses, no questions, every tier. The interest? Ah. The interest is a later problem.",
            "The Bridgeguard does not patrol Canal Seven after midnight. That is not a warning, friend. It is a schedule.",
            "You saw the red lanterns up in the ward? Fever ward. Ours burn a different red. Do not mix them up.",
            "Every payout goes in a book you will never read. Cheer up - almost nobody is ever page one.",
            "When the debt is called, it is called once, politely. There is no second call.",
        ),
    },
})
